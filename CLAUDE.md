...
| `memory/posted-linkedin/<slug>.md` | Full text of posted LinkedIn cross-posts (Pulse body + short feed post). For reuse as templates. Working examples: `ese-bot-eu-sovereign-rag`, `the-work-is-splitting`, `senior-developers-trust-ai-less`, `the-model-is-not-the-grader`, `verification-is-a-workflow-problem` (5 as of 2026-06-02). |
