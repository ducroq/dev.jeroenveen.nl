...
*Originally published at [dev.jeroenveen.nl/writing/the-work-is-splitting](https://dev.jeroenveen.nl/writing/the-work-is-splitting/)*
...
I keep running into the same moment in my own work: I review something AI helped me produce, and the validation is harder than the production was.

Production used to come with validation tangled into it. You couldn't write competent output without thinking about what could go wrong with it. AI breaks that. Production is now cheap and fast. Validation is not.

About 90% of engineering teams use AI tools now. In Jellyfish's 2025 survey, only 20% of organisations using AI extensively could measure their impact. The other 80% are doing the work and hoping.

Where in your work has validation become heavier than production? I am trying to trace this beyond one engineer's window.
...
1. Publish the LinkedIn article first. Copy its URL once live.
...
- If the Pulse article significantly outperforms the dev.jeroenveen.nl original on traffic, that confirms the LinkedIn-first strategy for posts 2 and 3 of the arc.
- Watch the comment-prompt response rate. The closing question ("where has validation become heavier than production?") is testing whether the audience filter is working.
